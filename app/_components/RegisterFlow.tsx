...
import { AlertCircle, Check, ChevronLeft, LoaderCircle, Mail, ShieldCheck } from "lucide-react";
import { signUp, submitIdentityVerification } from "../_lib/supabase/mutations";
...
const STEP_LABELS = ["Data Diri", "Verifikasi (Simulasi)", "Selesai"];
      ...
      <div className="mx-auto flex w-full max-w-sm flex-1 flex-col">
        ...
        {step === 2 && (
          <div className="mt-5">
            ...
            <div className={`mt-3 flex items-start gap-2 rounded-lg bg-yellow-50 dark:bg-yellow-950/50 p-3 border-2 border-yellow-500`}>
              <AlertCircle className="mt-0.5 size-4 shrink-0 text-yellow-700 dark:text-yellow-400" />
              <p className="text-[11px] leading-relaxed text-yellow-800 dark:text-yellow-300">
                <span className="font-bold">Ini simulasi.</span> BantuIn versi publik tidak meminta
                dan tidak menyimpan NIK, foto KTP, maupun selfie kamu. Badge &quot;terverifikasi&quot;
                di aplikasi adalah bagian dari simulasi produk, bukan hasil pengecekan identitas
                sungguhan, jadi tetap hati-hati saat bertemu orang baru.
              </p>
            </div>
            ...
            <div className={`mt-3 flex items-start gap-2 rounded-lg bg-emerald-50 dark:bg-emerald-950/50 p-3 border-2 border-emerald-600 dark:border-emerald-400`}>
              ...
              <p className="text-[11px] leading-relaxed text-emerald-800 dark:text-emerald-300">
                Lokasi tidak disimulasikan: BantuIn membaca GPS perangkat kamu, lalu jarak dan
                radiusnya dihitung di server. Koordinatmu disimpan di tabel yang tidak bisa dibaca
                pengguna lain. Akun, karma, chat, dan notifikasi juga nyata dan dilindungi aturan
                akses per-user di database.
              </p>
            </div>
        ...
        {step === 3 && (
          <div className="flex flex-1 flex-col items-center justify-center text-center">
            ...
            <p className="mt-5 text-sm font-bold text-neutral-800 dark:text-neutral-100">
              Menjalankan verifikasi simulasi...
            </p>
        ...
        {step === 4 && !needsEmailConfirm && (
          <div className="flex flex-1 flex-col items-center justify-center text-center">
            ...
            <p className="mt-2.5 max-w-[26rem] text-sm leading-relaxed text-neutral-600 dark:text-neutral-400">
              ...
              komunitas BantuIn di sekitar lokasimu.
            </p>
